...
const Settings = () => {
  ...
  const calculateMonthlyCost = () => {
    const modelCostPerToken = tokenCostMap[modelTier as keyof typeof tokenCostMap] || 0.01;
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-row items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <FormDescription>
                        Receive notifications about your quiz results and new content.
                      </FormDescription>
                    </div>
                    <FormControl>
                      <Switch
          ...
          <Card className="animate-in">
            <CardHeader>
              ...
              <CardDescription>
                Configure the AI model and token usage for generating practice questions.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <FormField
                  ...
                  <FormItem>
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="claude-3-opus">Claude 3 Opus (Comprehensive)</SelectItem>
                        <SelectItem value="gemini-pro">Gemini Pro (Balanced)</SelectItem>
                      </SelectContent>
                    </Select>
                    <FormDescription>
                      Select which AI model to use for generating and validating quiz content.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Monthly Token Budget: {field.value.toLocaleString()} tokens</FormLabel>
                    <FormControl>
                      <Slider
                        min={100000}
                        max={1000000}
            ...
            <CardFooter>
              <p className="text-xs text-muted-foreground">
                Higher token budgets allow for more question generation and validation.
                Your account will only be charged for tokens actually used.
              </p>
            </CardFooter>
          </Card>
